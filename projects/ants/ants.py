...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                if hasattr(self.ant, 'container') and self.ant.container:
                    ...
                    if type(self.ant) is not QueenAnt:
                        self.ant = None
                    else:
                        if self.ant.exist == 1:
                            self.ant = None               
                ...
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    ...
                    if type(self.ant.ant) is not QueenAnt:
                        self.ant.ant = None
                    else:
                        if self.ant.ant.exist == 1:
                            self.ant.ant = None
                else:
        ...
        if type(insect) is not QueenAnt:
            insect.place = None
        else:
            if insect.exist == 1:
                insect.place = None
...
class ThrowerAnt(Ant):
    ...
    food_cost = 3
    min_range = 0
    max_range = float('inf') #the funny thing about this is that 
                             # Prof.Denero Told me to put 10!!!
    ...
    def nearest_bee(self, hive):
        ...
        nearest = self.place
        counter = 0      
        while nearest.entrance is not hive:
            
            if nearest.bees and self.min_range <= counter and counter <= self.max_range:
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting > 0:
            ...
            while self.digesting == 0 and random_or_none(self.place.bees):
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        ...
        if not QueenAnt.real_queen:
            QueenAnt.real_queen = True
        else:    
            self.exist = 1
        # END Problem 9
    ...
    def action(self, colony):
        ...
        if self.exist != 0:
            ...
            loct = self.place.exit
            while loct != None:
                if loct.ant != None:
                    if loct.ant not in self.boosted:
                        if loct.ant.container:
                            if loct.ant.ant != None and loct.ant.ant not in self.boosted:
                                loct.ant.ant.damage *= 2
                                self.boosted += [loct.ant.ant]
                            loct.ant.damage *= 2
                                
                                
                            self.boosted += [loct.ant]
